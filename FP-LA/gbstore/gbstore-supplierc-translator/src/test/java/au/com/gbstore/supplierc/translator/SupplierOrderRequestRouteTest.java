...
public class SupplierOrderRequestRouteTest extends CamelTestSupport {
	...
	private static final String INPUT_MESSAGE = "supOrderReqRoute/msg/input/message-to-supplierc.xml";
	private static final String RESPONSE_MESSAGE = "supOrderReqRoute/msg/input/supplierc-response.xml";
	...
	protected CamelContext createCamelContext() throws Exception {
		...
		properties.setLocation("classpath:supOrderReqRoute/conf/au.com.gbstore.supplierc.translator.cfg");
	...
	protected RouteBuilder[] createRouteBuilders() throws Exception {
		return new RouteBuilder[] { new SupplierOrderRequestRoute(), new RouteBuilder() {
			...
			public void configure() throws Exception {
				from("{{spc.suporder.to}}").to(ExchangePattern.InOnly, "mock:toSupB").process(new Processor() {
	...
	public void messageFormat() throws CamelExecutionException, IOException, JAXBException, InterruptedException {
		...
		assertTrue(body.contains("supplierCMessage"));
	}
