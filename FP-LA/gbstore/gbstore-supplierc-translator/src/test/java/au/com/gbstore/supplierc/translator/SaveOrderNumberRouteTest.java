...
public class SaveOrderNumberRouteTest extends CamelTestSupport {
	...
	private static final String INPUT_MESSAGE = "saveOrderNumberRoute/msg/input/supplierc-response.xml";
	...
	protected CamelContext createCamelContext() throws Exception {
		...
		properties.setLocation("classpath:saveOrderNumberRoute/conf/au.com.gbstore.supplierc.translator.cfg");
