 ...
 *
 */
public class SupplierTranslatorRouteTest extends CamelTestSupport {

	private static final String INPUT_MESSAGE = "supplierTranslatorRoute/msg/input/message-to-suppliera.xml";
	private static final String RESPONSE_MESSAGE = "supplierTranslatorRoute/msg/input/suppliera-response.json";
	...
	protected CamelContext createCamelContext() throws Exception {
		...
		properties.setLocation("classpath:supplierTranslatorRoute/conf/au.com.gbstore.suppliera.translator.cfg");
	...
	public void testFinalMessageElements() throws CamelExecutionException, IOException, JAXBException {
		...
		SaveOrderNumber response = unmarshallerSupplierResponse(body);
	...
	public SaveOrderNumber unmarshallerSupplierResponse(String body) throws JAXBException {
