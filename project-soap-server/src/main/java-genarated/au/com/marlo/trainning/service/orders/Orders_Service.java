 ...
 * 2016-09-27T22:27:54.620-03:00
 * Generated source version: 3.0.2
 * 
 */
@WebServiceClient(name = "Orders", 
                  wsdlLocation = "file:/home/jefferson/workspace/project-soap-server/src/main/resources/wsdl/Orders.wsdl",
                  targetNamespace = "http://www.marlo.com.au/trainning/service/Orders/") 
public class Orders_Service extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://www.marlo.com.au/trainning/service/Orders/", "Orders");
    public final static QName OrdersSOAP = new QName("http://www.marlo.com.au/trainning/service/Orders/", "OrdersSOAP");
    static {
        URL url = null;
        try {
            url = new URL("file:/home/jefferson/workspace/project-soap-server/src/main/resources/wsdl/Orders.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Orders_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/jefferson/workspace/project-soap-server/src/main/resources/wsdl/Orders.wsdl");
        }
        WSDL_LOCATION = url;
    }
