 ...
 * 2016-09-25T11:40:21.835-03:00
 * Generated source version: 2.7.8
 * 
 */
@WebServiceClient(name = "Orders", 
                  wsdlLocation = "http://localhost:8080/project-soap-server/services/orders?wsdl",
...
public class Orders_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/project-soap-server/services/orders?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Orders_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/project-soap-server/services/orders?wsdl");
        }
        WSDL_LOCATION = url;
    }
